        ...
        <div class="container" style="background:rgba(255, 255, 255, 0.5);">
          ...
          <div class="admin-header">
            <div>
              <h1>BOOKINGS</h1></div>
            <div>
              <a href="admin.php" class="subNotes">
              <button class="btn btn-primary pull-right">USERS</button>
            </a>
            </div>
          ...
          <div class="list-group">
            <a href="#reason" data-toggle="collapse" class="list-group-item purpose list-group-item-action flex-column align-items-start">
              <div class="d-flex w-100 justify-content-between">
                ...
                <p><span class="var-starttime">
                 <?php echo datetime_to_text($books->start); ?></span> -
                 
                 <span class = "var-starttime" > <?php echo datetime_to_text($books->end); ?></span></p>
              </div>
            </a>
                    <?php endforeach; ?>
          </div>
